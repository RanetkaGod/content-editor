<template>
    <div class="image-button-wrapper">
        <svg class="image-button" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24">
        ...
        <input @change="$emit('image_load', $event)" ref="image_loader" type="file" id="image-picker" accept="image/jpeg,image/png,image/gif"/>
    </div>
</template>

<script>
    export default {
        name: "ContentEditorBoxEditAddImage"
    }
</script>
